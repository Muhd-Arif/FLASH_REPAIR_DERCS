    ...
    <div class="container">
        ...
        <div class="order-wrapper <?php echo $rpstatus=='Cannot be repaired' ?'hide-status':'show-status';?>">
            <div class="order-tracker">
                ...
                <div class="<?php echo $rpstatus=='In Progress' || $rpstatus=='Completed' || $rpstatus == 'Paid' || $rpstatus == 'COD Pending'?'complete':'';?> delivering">
                ...
                <div class="<?php echo $rpstatus=='Completed' || $rpstatus == 'Paid' || $rpstatus == 'COD Pending'?'complete':'';?> delivered">
