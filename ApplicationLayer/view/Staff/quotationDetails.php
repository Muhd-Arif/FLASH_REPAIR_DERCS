    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group row mb-3 mt-5">
                ...
                <div class="col-sm-7">
                    <input type="text" readonly class="form-control-plaintext" id="inputEmail"
                        placeholder="<?=$c_name[$k]?>" value="<?=$c_name[$k]?>">
                </div>
            </div>
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-7">
                    <input type="text" readonly class="form-control-plaintext" id="inputPassword"
                        placeholder="<?=$c_phone[$k]?>" value="<?=$c_phone[$k]?>">
                </div>
            </div>
            <div class="form-group row mb-3">
                <label for="inputDate" class="col-sm-5 col-form-label">Date</label>
                <div class="col-sm-7">
                    <input type="text" readonly class="form-control-plaintext" id="inputDate"
                        placeholder="<?=$q_date[$k]?>" value="<?=$q_date[$k]?>">
                </div>
            </div>
            <div class="form-group row mb-3">
                <label for="deviceType" class="col-sm-5 col-form-label">Device Type</label>
                <div class="col-sm-7">
                    <input type="text" readonly class="form-control-plaintext" id="deviceType"
                        placeholder="<?=$q_deviceType[$k]?>" value="<?=$q_deviceType[$k]?>">
                </div>
            </div>
            ...
            <div class="form-group row mb-5">
                ...
                <div class="col-sm-7">
                    <input type="text" readonly class="form-control-plaintext" id="status"
                        placeholder="<?=$q_status[$k]?>" value="<?=$q_status[$k]?>">
                </div>
            </div>
            ...
            <div class="col-md-12 text-center mt-5 mb-5">
                ...
                <button type="submit" name="add" class="btn btn-primary">Generate Quotation</button>
                <?php } ?>
            </div>
        </form>
    </div>
