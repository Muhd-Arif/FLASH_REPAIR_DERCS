...
$data = $product->viewAllPickup();




if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    $product->acceptPickup($RunnerID);
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">List of Available Pickup</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">List of Available Pickup</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="myDelivery.php" class="btn btn-sm btn-info float-left">Pending Delivery</a>
                <a href="myPickup.php" class="btn btn-sm btn-secondary float-right">Pending Pickup</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
