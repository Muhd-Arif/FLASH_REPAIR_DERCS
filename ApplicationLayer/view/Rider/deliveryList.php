  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">List of Available Delivery</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">List of Available Delivery</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-8">
            ...
            <div class="card">
                                  ...
                                  <td>
                                     <form id="delivery-form" method="post" >
                                      ...
                                      <div class="" id="button1" style="margin-right:5px">
                                          <input type="hidden" name="OrderProductID" value="<?=$row['D_ID']?>">
              ...
              <div class="card-footer clearfix">
                <a href="myPickup.php" class="btn btn-sm btn-info float-left">Pending Pickup</a>
                <a href="myDelivery.php" class="btn btn-sm btn-secondary float-right">Pending Delivery</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
