        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">List of Accepted Delivery</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">List of Accepted Delivery</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                         ...
                         foreach($data as $row){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form id="delivery-form" method="post"
                                                            action="updateDelivery.php">
                                                            <input type='hidden' id="" name='DeliveryID'
                                                                value="<?=$row['D_ID']?>'">
                              ...
                              ?>
                                ...
                                <div class="card-footer clearfix">
                                    <a href="pickupList.php" class="btn btn-sm btn-info float-left">Open Pickup
                                        Request</a>
                                    <a href="deliveryList.php" class="btn btn-sm btn-secondary float-right">Open
                                        Delivery Request</a>
                                </div>
                                <!-- /.card-footer -->
                            </div>
